...
const CompleteLesson = ({ pageContext }) => {
  ...
  const crumbPaths = crumbs.map((crumb) =>
    crumb.crumbLabel === "tag-questions"
      ? {
          ...crumb,
          pathname: "/learning",
        }
    ...
    <Layout>
      ...
      <AsideRight>
          ...
          <article className="pad1">
            ...
            <section className="flexCol">
              ...
              <div className={body}>
                ...
                <p>
                  They are very small question added or 'tagged' on to the end
                  of a statement.
                </p>
                <Spacer size={4} />
                <TextEmphasisBoxMinor>
                  <p>
                    If the statement is positive, the tag question <em>must</em>{" "}
                    be negative.
                  </p>
                </TextEmphasisBoxMinor>
                <ul className="pad1">
                  <li>
                    <Arrow
                      ...
                      color="dark"
                    />
                    This is a positive statement with a negative tag question,
                    isn't it?
                  </li>
                  <li>
                    <Arrow
                ...
                <TextEmphasisBoxMinor>
                  <p>
                    But, if the statement is negative then the tag question{" "}
            ...
            <section className="flexCol">
              ...
              <div className={body}>
                <p>
                  Tag questions are mostly used in informal conversations and
                  used a lot.
                </p>
                <p>
                  Tag questions are rarely written down and when they are the
                  message is often meant harshly.
                </p>
                <p>
                  But, if you are writing a sentence with a tag question place a{" "}
                  <em>comma</em> between the statement and the tag question.
                </p>
              </div>
            </section>
            <section className="flexCol">
                ...
                <ul className="pad1">
                  ...
                  <ul className="pad1">
                    <li>
                      ...
                      />{" "}
                      <em>
                        Auxiliary verb + main verb, the same auxiliary verb +
                        pronoun?
                      </em>
                    </li>
                    <ul className="pad1">
                ...
                <ul className="pad1">
                  ...
                  <li>
                    ...
                    <Arrow
                      ...
                      color="dark"
                    />{" "}
                    You kept the receipt, didn't you?
                  </li>
                  <li>
                    Didn't I ask you?{" "}
                    <Arrow
        ...
        <aside className="sideBorderDark sideBorderPad">
          ...
          <Spacer size={4} />
          <SimpleLink
            linkTo="learningh/using-get/complete-lesson"
            activeClassName="isActive"
