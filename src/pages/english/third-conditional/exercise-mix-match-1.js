...
import { thirdConditional1 } from "../../../support/types/englishExerciseAnswers";
      ...
      <AsideRight>
        <Main size={ 1 }>
          ...
          <TextEmphasisBoxMinor>
            <p className="textCenter">Match the if clause on the left to the result clause on the right.</p>
          </TextEmphasisBoxMinor>
          <Spacer size={ 2 } />
        ...
        <aside className="sideBorderLight sideBorderPad">
          ...
          <Spacer size={ 4 } />
          <SimpleLink
            linkTo="english/third-conditional/exercie-mix-match-1"
            activeClassName="isActive"
