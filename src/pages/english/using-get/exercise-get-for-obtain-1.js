    ...
    <Layout>
      ...
      <AsideRight>
        <Main size={ 1 }>
          <Spacer size={ 3 } />
          <TextEmphasisBox>
            <p>Often <em>get</em> is used instead of alternative words.</p>
          ...
          <TextEmphasisBoxMinor>
            ...
            <Spacer size={ 3 } />
            <p>Choose an alternative meaning from the verbs below, then change the verb into the correct tense.</p>
            <ol>
              <li>To achieve</li>
              <li>To buy</li>
              <li>To fetch</li>
          ...
          <section className="flexColumn">
            ...
            <p>'He decided to take a year off after that and drive around Europe in his new car. I was a bit worried, I'll be honest with you. But, he's a sensible boy; he { answerInput( 5 ) } his cleverness from me, so he does. I knew he'd be all right but still, a mother worries!'</p>
          ...
          <Spacer size={ 3 } />
          { !success && <Button onClick={ handleSubmit } innerText="Submit" /> }
          { submitted && success && <p style={ { fontSize: "2rem", textAlign: "center", padding: "1rem" } }>Congratulations, you did it!</p> }
