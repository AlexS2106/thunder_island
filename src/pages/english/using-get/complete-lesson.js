...
const CompleteLesson = ( { pageContext } ) => {
  ...
  const crumbPaths = crumbs.map( crumb => crumb.crumbLabel === "using-get" ? {
    ...crumb,
    pathname: "/english"
  } : crumb );
  ...
  return (
    <Layout>
      ...
      <Spacer size={ 3 } />
      <PageTitle title={ pageTitle } size={ 1 } />
      <Spacer size={ 2 } />
      <AsideRight>
        <Main size={ 1 }>
          <article className="pad1">
            ...
            <Spacer size={ 4 } />
            <p>The first sentence uses the more formal verb and in the second sentence the formal verb replaced wth get.</p>
            <Spacer size={ 4 } />
            ...
            <section className="flexColumn">
              ...
              <div className={ body }>
                ...
                <ul className={ list }>
                  <li>I liked him for so long, and then, I caught him! <Arrow type="x2" direction="right" color="dark" /> I liked him for so long, and now I got him!</li>
                  <li>He caught himself a great wife! <Arrow type="x2" direction="right" color="dark" /> He got himself a great wife!</li>
                  <li>They caught the thieves. <Arrow type="x2" direction="right" color="dark" /> They got the thieves.</li>
                </ul>
                <Spacer size={ 3 } />
            ...
            <section className="flexColumn">
              ...
              <div className={ body }>
                ...
                <ul className={ list }>
                  <li>They contracted some horrible disease while they were travelling. <Arrow type="x2" direction="right" color="dark" /> They got some horrible disease while they were travelling. </li>
            ...
            <section className="flexColumn">
              ...
              <div className={ body }>
                ...
                <ul className={ list }>
                  ...
                  <li>They will understand if you explain slowly. <Arrow type="x2" direction="right" color="dark" /> They will get it if you explain slowly.</li>
                </ul>
              </div>
            </section>
            <Spacer size={ 2 } />
            ...
            <section className="flexColumn">
              ...
              <div className={ body }>
                <section className="flexColumn">
                  ...
                  <div className={ list }>
                    <h6><Arrow type="x1" direction="right" color="accentLight" /> To be mobile</h6>
                    <ul className={ list }>
                ...
                <section className="flexColumn">
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> To successfully communicate an idea.</h6>
                  <ul className={ list }>
                    <li>I'm not sure he got his view across in that meeting.</li>
                    <li>If I can get my point across, I am sure you will agree.</li>
                  </ul>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> To cross from one side to another.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn">
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Do better than.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> To start something. (Usually, this is something you don't really want to do.).</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> To repeatedly criticise someone.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Successfully leave after a crime.</h6>
                  <ul className={ list }>
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Do something and not be caught or punished.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Return to a place or person.</h6>
                  <ul className={ list }>
                    <li>We should get back by 7:30.</li>
                    <li>She got him back.</li>
                  </ul>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Move backwards(often as a warning).</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" />Become late with paying for something. (Also 'fell behind'.)</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Manage with difficulty.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Enter a house, car, swimmming pool or container.</h6>
                  <ul className={ list } >
                    <li>Get in the car!</li>
                    <li>The water in the swimming pool is so warm! You should get in!</li>
                  </ul>
                  <h4 className="shadowText">Get out</h4>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Exit a house, car, swimmming pool or container.</h6>
                  <ul className={ list } >
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Enter a bus, train, plane, bike or boat.</h6>
                  <ul className={ list }>
                    <li>Let's get on the bus.</li>
                    <li>We are getting on the plane now!</li>
                  </ul>
                  <h4 className="shadowText">Get off</h4>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Exit a bus, train, plane, bike or boat.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  <h4 className="shadowText">Get off</h4>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Stop</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Have a good relationship with someone.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Becoming older</h6>
                  <ul className={ list } >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Time is becoming late.</h6>
                  <ul className={ list } >
                ...
                <section className="flexColumn" >
                  <h4 className="shadowText">Get out</h4>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Leave</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" />Avoid doing something you don't want to do.</h6>
                  <ul className={ list }>
                    <li>I told my teacher I was ill and I got out of doing the exam today.</li>
                    <li>I got out of cleaning my room.</li>
                  </ul>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Leave a bad relationship.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Recover from an illness or a bad situation.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Throw someone or something away</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" />Delayed</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" />Make contact</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Communicate an understanding</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Reach a place.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Leave your bed after waking.</h6>
                  <ul className={ list }>
                    <li>I got up at 7:30.</li>
                    <li>What time are you getting up tomorrow? </li>
                  </ul>
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Rise from a chair or the floor.</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn" >
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" />Do</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn">
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Adjust to something</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn">
                  ...
                  <h6><Arrow type="x1" direction="right" color="accentLight" /> Get angry</h6>
                  <ul className={ list }>
                ...
                <section className="flexColumn">
                  ...
                  <p><Arrow type="x1" direction="right" color="accentLight" /> Used as 'to have'. (It is always 'have got', never 'have get'.)</p>
                  <ul className={ list }>
        ...
        <aside className="sideBorderDark sideBorderPad">
          ...
          <Spacer size={ 4 } />
          <SimpleLink 
            linkTo="/english/using-get/exercise-get-for-obtain-1"
            activeClassName="isActive"
...
export const Head = () => <Seo title="Thunder Island | English Grammar: Get And Got" />;
