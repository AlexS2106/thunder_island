...
export function listSubcategories ( frontmatter ) { 
  let arr = [];
  if ( frontmatter.subcategories ) { arr.concat(frontmatter.subcategories)}
  if ( frontmatter.by_course ) { arr.concat( frontmatter.by_course ) }
  if ( frontmatter.by_diet ) { arr.concat( frontmatter.by_diet ) }
  if ( frontmatter.by_ingredient ) { arr.concat( frontmatter.by_ingredient ) }
  return arr;
}
