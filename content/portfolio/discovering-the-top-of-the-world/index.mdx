...
The left turn took us to a slightly rougher track with a death-defying drop on the right side mitigated by a wall above the height of my eldest child without holes at the bottom, large enough for my youngest. The left side was a steep, rocky yet flora-covered hill. In relative safety, the kids were allowed off-hand. They ran by themselves along the path while other families did the same. The walk wasn't busy, but it wasn't deserted either.
