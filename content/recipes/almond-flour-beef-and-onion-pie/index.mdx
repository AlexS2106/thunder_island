...
associated: 
  ...
  - crusty-bread
  - tricolour-salad
description: Slow-cooked beef and onion with an almond flour crusty pastry topping. Easy-to-make comfort food for the paleo diet.
---
...
#### Method
  ...
  - **Step 2**
    - Melt the lard on high heat in a medium-sized frying pan. (I use the number 8.)
  ...
  - **Step 3**
    - Lower the heat down to medium. (I use the number 6) 
