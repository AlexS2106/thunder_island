...
associated: 
  ...
  - smothered-chicken
description: An gluten-free 'alternative' bread made with almond flour, coconut flour and egg. So easy, it's cooked on the hob, ready in just 10 minutes!
---
...
#### Method
  ...
  - **Step 2**
    - Melt the ghee in a small frying pan/skillet over medium heat. (I use the number 6.)
  - **Step 3**
...
It is tempting to reduce or remove the ghee from the ingredient list; unfortunately, the ghee is necessary. Coconut flour is super absorbent and will soak up everything. I found that ½ tbsp of the ghee was the *exact* amount needed to prevent sticking but not be wasteful. 
